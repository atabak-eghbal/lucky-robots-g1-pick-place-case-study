...
- **Video evidence gallery:** include three recordings with clear framing by workstream — Work 1 FSM baseline (reliable completed baseline), Work 2 scripted keyboard teacher infrastructure, and Work 3 current physical-grasp experiment (near pickup / slipping during lift; not solved).
