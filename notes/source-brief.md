...
- **VLA Roadmap:** living OpenVLA/OpenVLA-style research branch. Step 12 documented the scaffold; Step 13 validated the 7D action adapter; Step 14 recorded FSM teacher demonstrations; Step 15 validated replay tooling; Step 16 proved G1-native teacher-command replay is faithful while hybrid-7D fails; Step 17 exported a G1-native supervised dataset with 2665 records and an 8D action vector. The next step is dataset audit and train/validation split before any OpenVLA inference or fine-tuning.
